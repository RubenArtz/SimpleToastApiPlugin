...
public class SimpleToast {
    ...
    static {
        ...
        try {
            toastWrapper = (IToastWrapper) Class.forName(String.format("ruben_artz.toast.libs.nms.v%s.ToastImpl", version.getNMSVersion().getVersionName())).getDeclaredConstructors()[0].newInstance();
        } catch (Exception e) {
