package artzstudio.dev.toast.utils;

import artzstudio.dev.toast.Main;
...
public class Updater {
    ...
    private static final String UPDATE_URL = "https://artzstudio.dev/versions/toast.txt";
    ...
    private static void notifyUpdateAvailable(String latestVersion) {
        ...
        Main.sendMessage("&9https://artzstudio.dev/toast-api");
